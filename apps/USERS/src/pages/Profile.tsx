...
const Profile = () => {
    ...
    return (
        <div className='p-4 pt-14'>
            <div className='border border-[#DBEAFE] py-3 px-4 rounded-md space-y-4'>
                <div className="flex items-center justify-between">
                    <div className="space-y-3">
                        ...
                        <div onClick={()=>navigate('/edit-profile')} className="flex items-center gap-1">
                            <FaUser size={16} />
            ...
            <button className="mt-40 bg-[#2563EB] w-full h-[50px] font-semibold text-sm text-white py-2 px-4 rounded-md">Log Out</button>
