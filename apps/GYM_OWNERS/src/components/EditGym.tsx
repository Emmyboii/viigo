...
export default function EditGym({ display, setDisplay, gym, setGym }: EditGymProps) {
    ...
    const [addressLine2, setAddressLine2] = useState(gym?.address_line_2 || "");
        ...
        <div className="min-h-screen pb-32">
            ...
            <LocationModal
                ...
                onSave={(data) => {
                    ...
                    setLocation(
                        `${data.address_line_1}, ${data.address_line_2}, ${data.city}, ${data.state} ${data.postal_code}`
                    );
                }}
            />
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex">
            <div className="bg-white w-full p-5 h-screen flex flex-col">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto">
                    ...
                    <LocationInput label="Address Line 1" value={line1} onChange={setLine1} />
                    <LocationInput label="Address Line 2" value={line2} onChange={setLine2} />
                    <LocationInput label="City" value={cityValue} onChange={setCity} />
                    <LocationInput label="State" value={stateValue} onChange={setState} />
                    <LocationInput label="ZIP / Postal Code" value={zip} onChange={setZip} />
                </div>
    ...
    return (
        <div>
            ...
            <input
                ...
                title="location"
                onChange={(e) => onChange(e.target.value)}
                className="border border-[#475569] w-full rounded-lg px-3 py-2 outline-none"
            />
        </div>
    );
}